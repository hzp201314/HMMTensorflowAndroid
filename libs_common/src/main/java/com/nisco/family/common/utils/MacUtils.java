...
/**
 * Created by tianzy on 2018/11/20.
 */
    ...
    public static String getMac(Context context) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) { // 6.0 以下
            ...
            return strMac;
                ...
                && Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) { // 6.0以上7.0以下
            strMac = getMacAddress(context);
            return strMac;
        } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) { // 7.0 以上
            if (!TextUtils.isEmpty(getMacAddress())) { // 7.0以上1
