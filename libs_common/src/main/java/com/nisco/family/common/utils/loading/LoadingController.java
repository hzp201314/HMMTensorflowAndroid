...
public class LoadingController implements LoadingInterface {
    ...
    public void showLoading() {
        ...
        loadingView = inflater.inflate(R.layout.common_loading, null);
    ...
    public void showNetworkError() {
        ...
        networkErrorView = inflater.inflate(R.layout.common_error, null);
        ...
        tvNetworkErrorMessage.setText(context.getResources().getString(R.string.common_loadingController_network_error_message));
    ...
    public void showError() {
        ...
        errorView = inflater.inflate(R.layout.common_error, null);
        ...
        ivError.setImageResource(R.drawable.common_error);
        ...
        if (!TextUtils.isEmpty(errorMessage)) {
            ...
            tvErrorMessage.setText(context.getResources().getString(R.string.common_loadingController_error_message));
        }
    ...
    public void showEmpty() {
        ...
        emptyView = inflater.inflate(R.layout.common_error, null);
