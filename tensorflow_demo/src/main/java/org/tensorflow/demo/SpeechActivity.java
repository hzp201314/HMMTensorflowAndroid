 ...
 */
@Route(path = "/tensorflow/activity/SpeechActivity")
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                labels.add( line );//将标签添加到labels
                if (line.charAt( 0 ) != '_') {
//          首字母转大写存入displayedLabels数组中
        ...
        // Load the TensorFlow model.加载模型
