package com.nisco.hzp.mnistdemo;
...
import com.nisco.hzp.mnistdemo.views.DrawModel;
import com.nisco.hzp.mnistdemo.views.DrawView;
 ...
 */
@Route(path = "/mnist/activity/MainActivity")
public class MainActivity extends Activity implements View.OnClickListener, View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mnist_activity_main);
